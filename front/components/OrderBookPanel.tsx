  ...
  return (
    <PanelWrapper>
      ...
      <CardHeader className="bg-background backdrop-blur-xl flex-shrink-0 px-4 py-3 h-[60px] flex items-center">
        <div className="flex items-center justify-between w-full">
          ...
          <Select value={stepSize} onValueChange={setStepSize}>
            <SelectTrigger size="sm" className="w-[70px] bg-card backdrop-blur-sm border-primary/25 text-foreground focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 hover:bg-card/80">
              <SelectValue>
      ...
      <CardContent className="p-0 flex-1 overflow-hidden flex flex-col">
        {/* Simple Table Header */}
        <div className="grid grid-cols-3 gap-2 px-3 py-1.5 border-b border-primary/25 bg-card flex-shrink-0">
            ...
            <div>
              ...
              {aggregatedAsks.length > 0 &&
                ...
                (() => {
                  ...
                  return (
                    <div
                      className="grid grid-cols-3 gap-2 py-2 px-3 bg-primary/10 hover:bg-primary/20 border-y border-primary/25 relative overflow-hidden cursor-pointer transition-all duration-300 group"
                      onClick={() =>
        ...
        {/* Footer Status Bar */}
        <div className="px-3 py-2 border-t border-primary/25 bg-card flex-shrink-0">
