...
const GlassButton: React.FC<GlassButtonProps> = ({ active, onClick, children, variant = 'default', ...props }) => {
  const variants: Record<ButtonVariant, string>  = {
    default: active 
      ...
      : 'bg-gradient-to-br from-primary/10 via-primary/5 to-primary/10 hover:from-primary/20 hover:via-primary/15 hover:to-primary/20 text-primary/80 border border-primary/20 hover:border-primary/30 shadow-lg shadow-primary/20',
    danger: active
